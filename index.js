...
// Унікальні символи
// Напишіть функцію, яка перевіряє, чи містить рядок тільки унікальні символи.
...
// Баланс дужок
// Напишіть функцію, яка перевіряє, чи правильно розставлені круглі дужки.
...
//     for (let char of str) {
//         // Если это открывающая скобка, кладем её в стек
//         if (brackets[char]) {
//             stack.push(char);
//         }
...
//                 return false; // Если не соответствует, то сбалансированности нет
//             }
//         }
//     }
...
// Реалізуй метод mySlice для масивів, який працюватиме так само, як вбудований slice.

// Він повинен приймати два аргументи: start (початковий індекс) і end (не включно).

// Якщо start або end негативні, вони рахуються з кінця масиву.

// Якщо end не передано, обрізка йде до кінця масиву.

// Array.prototype.mySlice = function(start = 0, end = this.length) {
//     let result = [];
//     let actualStart = start < 0 ? this.length + start : start;
//     let actualEnd = end < 0 ? this.length + end : end;
...
// Напиши власну реалізацію Array.prototype.map(), назвавши її myMap.
// Метод повинен:

// Приймати колбек-функцію

// Викликати цю функцію для кожного елемента масиву

// Повернути новий масив із результатами виклику функції

// Коректно працювати зі this
...
// Напиши свій метод myFilter(), який працює точно як метод filter масиву, але без використання стандартного filter.

// Метод myFilter() має приймати:

// callback – функцію, яка буде застосовуватися до кожного елемента масиву. Ця функція повинна повертати true або false. Якщо вона повертає true, елемент потрапляє в новий масив.

// this – поточний масив (як у попередніх методах).

// Важливо:

// Якщо callback не є функцією, має бути викинуте помилку.

// Метод має повертати новий масив з елементами, які пройшли перевірку за допомогою callback.
...
// console.log(func(48, 18));

// ________________________________________________________________________________________________________________________________________________________________________________________________________________

// Перетворити масив об'єктів у один об'єкт, згрупувавши за певним ключем.

// function func(arr, group) {
//     let obj = {};
    
//     for (let i = 0; i < arr.length; i++) {
//          // Беремо значення поля, за яким групуємо
//         let key = arr[i][group];
...
//         // Додаємо об'єкт у відповідну групу
//         obj[key].push(arr[i])
//     }
...
//     { id: 2, group: "B", name: "Alice" },
//     { id: 3, group: "A", name: "Mike" },
//     { id: 4, group: "C", name: "Sarah" },
//     { id: 5, group: "B", name: "Tom" }
// ];

// console.log(func(testData, "group"));
